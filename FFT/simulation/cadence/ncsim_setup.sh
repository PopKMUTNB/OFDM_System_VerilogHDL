...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_1n64sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_2n64cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_2n64sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_3n64cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_3n64sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_1n64cos.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FFT_fft_ii_0.sv"                           -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/FFT.v"                                                                                                  
fi
