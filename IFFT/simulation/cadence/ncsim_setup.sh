...
TOP_LEVEL_NAME="IFFT"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="D:/applications/intelfpga/18.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/IFFT_fft_ii_0_1n64cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/IFFT_fft_ii_0_2n64cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/IFFT_fft_ii_0_1n64sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/IFFT_fft_ii_0_2n64sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/IFFT_fft_ii_0_3n64cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/IFFT_fft_ii_0_3n64sin.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_sink.vhd"       -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_source.vhd"     -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_controller.vhd" -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/IFFT_fft_ii_0.sv"                          -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/IFFT.v"                                                                                                 
fi
